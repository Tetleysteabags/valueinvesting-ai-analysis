#!/usr/bin/env python3
"""
Test positions history recording
"""
...
def test_positions_history():
    """Test that positions history is being recorded correctly"""
    
    tickers = ['ICCC']  # Use a single ticker for testing
    
    print(f"🧪 Testing positions history recording with: {tickers}")
